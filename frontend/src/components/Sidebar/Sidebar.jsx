...
{
  SidebarTopics.map((sideBarTopic)=>(
      <li className='p-6 pr-2 pl-7 relative text-sky-500 border-b border-black transition-all duration-200 hover:bg-slate-200 dark:hover:bg-zinc-800'>
